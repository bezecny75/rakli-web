...
## Current Branch
main (projekt ještě nezaložen — toto je iniciální stav)
...
- Repo zatím NENÍ založeno, Astro projekt NENÍ inicializován
- Kontaktní formulář aktuálně bez backendu (posílá na mail přes WP) — nutno nahradit

## Last Completed Work
- 2026-06-30
- commit: N/A (ještě nezaloženo)
- Vytvořen plán migrace a struktura `.agent/` dokumentace
- Testy: žádné (plánovací fáze)

## Next Steps
1. Založit GitHub repo a inicializovat Astro projekt (`npm create astro@latest`)
2. Migrovat obsah z rakli.cz do content collections (hodiny, aktuality, FAQ, ceník, služby, kontakt)
3. Nahradit kontaktní formulář přes Web3Forms a otestovat FTP deploy
...
- FTP přístupové údaje zatím nedodány
